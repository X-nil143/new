...
def apk(uid,pwx,tl):
    ...
    # 'cookie': 'datr=HQ7dZLwQVBV1WPHNyehIkRDh; sb=2kLdZEyH7o32q4h9eNO59h9a; dnonce=AWlyBCWHeGi1UUqFhTIw5DCHaAJ0MZeXgGjRLSL38PsgJKhmDGxZeru3SgtA15syuf0x46jrdYQFINonUz5ZpI7J; fr=0uFsVmZyihTn9xRyS..Bk3ULk.pN.AAA.0.0.Bk3UL2.AWUo4jqMq9A',
...
def mix(uid,pwx,tl):
    ...
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=HQ7dZLwQVBV1WPHNyehIkRDh; sb=2kLdZEyH7o32q4h9eNO59h9a; m_pixel_ratio=2.4750001430511475; dnonce=AWn0qqJhUjxL1PTS-C3AlMN_4RO7xtsFrA5gvO3997dfSge6eIGKFKMgKkHT25emZ4LqoBMyprfxk7lbjvS28jHH; wd=437x831; fr=0uFsVmZyihTn9xRyS..Bk3ULk.pN.AAA.0.0.Bk3UPC.AWU0-FFkFxY',
    'dpr': '2.4750001430511475',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Chromium";v="107", "Not=A?Brand";v="24"',
    'sec-ch-ua-full-version-list': '"Chromium";v="107.0.5304.74", "Not=A?Brand";v="24.0.0.0"',
...
def fcrack(uid,pwx,tl):
    ...
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=HQ7dZLwQVBV1WPHNyehIkRDh; sb=2kLdZEyH7o32q4h9eNO59h9a; m_pixel_ratio=2.4750001430511475; dpr=2.4750001430511475; dnonce=AWmJnwRNwIfR6Q6CP6CgpmrmmILy6mqBP9Vzdq_Y1QoJoyN87-pstrg6ij-pGMRylVXMPuq0WguKsQ4cvUbJ1HqT; wd=437x857; fr=0uFsVmZyihTn9xRyS..Bk3ULk.pN.AAA.0.0.Bk3URO.AWWkFvVdfGM',
    'dpr': '2.4750001430511475',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Chromium";v="107", "Not=A?Brand";v="24"',
    'sec-ch-ua-full-version-list': '"Chromium";v="107.0.5304.74", "Not=A?Brand";v="24.0.0.0"',
